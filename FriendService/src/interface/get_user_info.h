...
class GetUserInfoImpl : public lightrpc::RpcInterface{
public:
    GetUserInfoImpl(const google::protobuf::Message* req, google::protobuf::Message* rsp, google::protobuf::RpcController* controller, ::google::protobuf::Closure* done):
    lightrpc::RpcInterface(req, rsp, controller, done){}

    void Run(){
        try {
            // 初始化请求和响应
            auto req = dynamic_cast<const ik_FriendService::UserInfoRequest*>(m_req_base_);
            auto res = dynamic_cast<ik_FriendService::UserInfoReponse*>(m_rsp_base_);
