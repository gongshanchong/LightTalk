...
class AddFriendImpl : public lightrpc::RpcInterface{
public:
    AddFriendImpl(const google::protobuf::Message* req, google::protobuf::Message* rsp, google::protobuf::RpcController* controller, ::google::protobuf::Closure* done):
    lightrpc::RpcInterface(req, rsp, controller, done){}

    void Run(){
        try {
            // 初始化请求和响应
            auto req = dynamic_cast<const ik_FriendService::AddFriendRequest*>(m_req_base_);
