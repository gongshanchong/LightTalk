...
class LogResponse final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::ik::ErrorMsg* release_msg();
  ...
  void unsafe_arena_set_allocated_msg(
      ::ik::ErrorMsg* msg);
  ::ik::ErrorMsg* unsafe_arena_release_msg();
...
class LogServiceRpc_Stub;

class LogServiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline LogServiceRpc() {};
 public:
  virtual ~LogServiceRpc();

  typedef LogServiceRpc_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(LogServiceRpc);
};

class LogServiceRpc_Stub : public LogServiceRpc {
 public:
  LogServiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  LogServiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(LogServiceRpc_Stub);
};
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LogRequest::set_msg(ArgT0&& arg0, ArgT... args) {
...
inline const ::ik::ErrorMsg& LogResponse::_internal_msg() const {
  const ::ik::ErrorMsg* p = _impl_.msg_;
...
inline void LogResponse::unsafe_arena_set_allocated_msg(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ik.LogResponse.msg)
}
inline ::ik::ErrorMsg* LogResponse::release_msg() {
  
  ::ik::ErrorMsg* temp = _impl_.msg_;
  _impl_.msg_ = nullptr;
...
inline ::ik::ErrorMsg* LogResponse::unsafe_arena_release_msg() {
...
inline ::ik::ErrorMsg* LogResponse::mutable_msg() {
  ::ik::ErrorMsg* _msg = _internal_mutable_msg();
