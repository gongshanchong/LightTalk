...
class LogErrorImpl : public lightrpc::RpcInterface{
public:
    LogErrorImpl(const google::protobuf::Message* req, google::protobuf::Message* rsp, google::protobuf::RpcController* controller, ::google::protobuf::Closure* done):
