...
class MsgRequest final :
 ...
 public:
  ...
  ~MsgRequest() override;
  explicit PROTOBUF_CONSTEXPR MsgRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const MsgRequest& from) {
    MsgRequest::MergeImpl(*this, from);
  }
  private:
...
inline int32_t MsgRequest::_internal_id() const {
  return _impl_.id_;
}
inline int32_t MsgRequest::id() const {
  // @@protoc_insertion_point(field_get:ik_ChatServer.MsgRequest.id)
  return _internal_id();
}
inline void MsgRequest::_internal_set_id(int32_t value) {
  
  _impl_.id_ = value;
}
inline void MsgRequest::set_id(int32_t value) {
...
void MsgRequest::set_msg(ArgT0&& arg0, ArgT... args) {
