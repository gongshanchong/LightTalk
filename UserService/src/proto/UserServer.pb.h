...
class LoginReponse final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::ik_UserServer::ErrorMsg* release_msg();
  ...
  void unsafe_arena_set_allocated_msg(
      ::ik_UserServer::ErrorMsg* msg);
  ::ik_UserServer::ErrorMsg* unsafe_arena_release_msg();
...
inline const ::ik_UserServer::ErrorMsg& LoginReponse::_internal_msg() const {
  const ::ik_UserServer::ErrorMsg* p = _impl_.msg_;
...
inline void LoginReponse::unsafe_arena_set_allocated_msg(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ik_UserServer.LoginReponse.msg)
}
inline ::ik_UserServer::ErrorMsg* LoginReponse::release_msg() {
  
  ::ik_UserServer::ErrorMsg* temp = _impl_.msg_;
  _impl_.msg_ = nullptr;
...
inline ::ik_UserServer::ErrorMsg* LoginReponse::unsafe_arena_release_msg() {
...
inline ::ik_UserServer::ErrorMsg* LoginReponse::_internal_mutable_msg() {
  ...
  if (_impl_.msg_ == nullptr) {
    auto* p = CreateMaybeMessage<::ik_UserServer::ErrorMsg>(GetArenaForAllocation());
    _impl_.msg_ = p;
  }
  return _impl_.msg_;
}
inline ::ik_UserServer::ErrorMsg* LoginReponse::mutable_msg() {
  ::ik_UserServer::ErrorMsg* _msg = _internal_mutable_msg();
